...
class ItemRepoTest {
    ...
    public void findByItemNmTest(){
        this.createItemList();
        List<Item> itemList = itemRepo.findByItemNm("테스트 상품1");
    ...
    public void findByItemNmOrItemDetailTest(){
        this.createItemList();
        List<Item> itemList = itemRepo.findByItemNmOrItemDetail("테스트 상품1", "테스트 상품 상세 설명5");
        for(Item item : itemList){
            System.out.println(item.toString());
        }
    }
    ...
    public void findByItemDetailTest(){
        this.createItemList();
        List<Item> itemList = itemRepo.findByItemDetail("테스트 상품 상세 설명");
        for(Item item : itemList){
            System.out.println(item.toString());
        }
    }
    ...
    public void queryDslTest(){
        ...
        List<Item> itemList = query.fetch();    // JPA쿼리 메서드 query.fetch()
    ...
    public void queryDslTest2(){
        ...
        Page<Item> itemPagingResult = itemRepo.findAll(booleanBuilder, pageable);
